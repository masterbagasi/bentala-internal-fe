...
const SEED: Record<string, string> = {
  ...
  // ── Chat actions / attachments / clear ──
  'Tulis pesan…': 'Write a message…',
  'Enter kirim · Shift+Enter baris baru': 'Enter to send · Shift+Enter for newline',
  'Belum ada pesan': 'No messages yet',
  'Mulai obrolan dengan tim': 'Start the conversation with the',
  'Ke pesan terbaru': 'Jump to latest',
  'Aksi': 'Actions',
  'Tarik': 'Unsend',
  '(diedit)': '(edited)',
  'Pesan ini ditarik': 'This message was unsent',
  'Lampirkan file': 'Attach file',
  'File terlalu besar (maks 10MB)': 'File too large (max 10MB)',
  'Tipe file tidak didukung': 'File type not supported',
  'Pilih': 'Select',
  'Batal pilih': 'Cancel selection',
  'dipilih': 'selected',
  'Kosongkan room': 'Clear room',
  'Hapus terpilih': 'Delete selected',
  'Hapus pesan terpilih': 'Delete selected messages',
  'pesan terpilih': 'selected messages',
  'Tindakan ini permanen.': 'This action is permanent.',
  'Kosongkan seluruh room? Semua pesan akan terhapus permanen.': 'Clear the entire room? All messages will be permanently deleted.',
  'Dibaca': 'Read by',
  'Gagal menarik pesan': 'Failed to unsend message',
  'Gagal mengedit pesan': 'Failed to edit message',
  'Gagal menghapus pesan': 'Failed to delete message',
